...
def test_genboot_produces_expected_script(tmp_path):
    ...
    expected_lines = [
        ...
        "fdt set /chosen/domU1 memory <0x0 0x2800>",
        "",
        ...
        "",
        "fdt mknod /chosen/domU1 module@0x04000000",
        ...
        "fdt set /chosen/domU2 memory <0x0 0x2800>",
        "",
        ...
        "",
        "fdt mknod /chosen/domU2 module@0x06000000",
...
def test_genboot_generates_all_domains_with_unique_params(tmp_path):
    ...
    expected_lines = [
        ...
        "fdt set /chosen/domU1 \\#address-cells <0x1>",
        "fdt set /chosen/domU1 \\#size-cells <0x1>",
        "fdt set /chosen/domU1 memory <0x0 0xc00000>",
        "",
        "fdt set /chosen/domU1 vpl011",
        ...
        "",
        "fdt mknod /chosen/domU1 module@0x04800000",
        ...
        "fdt set /chosen/domU2 \\#address-cells <0x1>",
        "fdt set /chosen/domU2 \\#size-cells <0x1>",
        "fdt set /chosen/domU2 memory <0x0 0x4000000>",
        "",
        "fdt mknode /chosen/domU2 module@0x05000000",
        ...
        "fdt set /chosen/domU3 memory <0x0 0x3000000>",
        "",
        ...
        "",
        "fdt mknod /chosen/domU3 module@0x07800000",
        ...
        "fdt set /chosen/domU4 memory <0x0 0x8000000>",
        "",
        ...
        "",
        "fdt mknod /chosen/domU4 module@0x09000000",
